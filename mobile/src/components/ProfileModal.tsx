...
import { ACCENT_PALETTES, type AccentColor, type ThemeMode } from '../theme/colors';
...
export const ProfileModal: React.FC<ProfileModalProps> = ({
  ...
  const handleAccentClick = (accentId: AccentColor) => {
    ...
    apiService.updateUserProfile(currentUser.id, undefined, pal.primary).then((updated) => {
  ...
  const handleSaveDisplayName = async () => {
    ...
    try {
      ...
      setStatusMessage({ text: 'Display name saved successfully!', isError: false });
    } catch (err: unknown) {
  ...
  const handlePickAvatar = async () => {
    try {
      ...
      if (!res.canceled && res.assets && res.assets.length > 0) {
        ...
        Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
        setStatusMessage({ text: 'Profile picture updated successfully!', isError: false });
      }
    } catch (err: unknown) {
      const msg = err instanceof Error ? err.message : String(err);
      setStatusMessage({ text: msg, isError: true });
  ...
  const handleChangePassword = async () => {
    if (!oldPassword.trim() || !newPassword.trim()) {
      setStatusMessage({ text: 'Please fill in both password fields.', isError: true });
      return;
    }
    if (newPassword.length < 6) {
      setStatusMessage({ text: 'New password must be at least 6 characters long.', isError: true });
      return;
    }
    ...
    try {
      ...
      setShowPasswordSection(false);
      Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
      setStatusMessage({ text: 'Password changed successfully!', isError: false });
    } catch (err: unknown) {
      const msg = err instanceof Error ? err.message : String(err);
      setStatusMessage({ text: msg, isError: true });
      Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
        ...
        <Pressable style={styles.backdrop} onPress={onClose}>
          <Pressable
            style={[
              ...
              { backgroundColor: theme.bgApp, borderColor: theme.borderSubtle },
            ]}
            onPress={(e) => e.stopPropagation()}
          >
            {/* Grabber Handle */}
            <View style={styles.handleContainer}>
              <View style={[styles.handleBar, { backgroundColor: theme.borderSubtle }]} />
            </View>
            ...
            <View style={[styles.header, { borderBottomColor: theme.borderSubtle }]}>
              <View style={styles.headerLeft}>
                ...
                <Text style={[styles.title, { color: theme.textMain }]}>Account & Settings</Text>
              </View>
              <TouchableOpacity
            ...
            {statusMessage && (
              <View
                style={[
                  styles.banner,
                  {
                    backgroundColor: statusMessage.isError ? theme.dangerLight : theme.emeraldLight,
                    borderColor: statusMessage.isError ? theme.dangerBorder : theme.emeraldBorder,
                  },
                ]}
              >
                <Feather
            ...
            >
              ...
              <View style={[styles.heroCard, { backgroundColor: theme.bgCard, borderColor: theme.borderSubtle }]}>
                <View style={styles.avatarSection}>
                  ...
                  >
                    {resolvedAvatar ? (
                      <Image source={{ uri: resolvedAvatar }} style={styles.largeAvatarImg} />
                    ) : (
                      <Text style={styles.largeAvatarText}>
                        {(displayName || currentUser.username || 'U').charAt(0).toUpperCase()}
                      </Text>
                    )}
                  </View>
                  ...
                  <View style={styles.avatarBtnRow}>
                    <TouchableOpacity
                      style={[styles.avatarActionBtn, { backgroundColor: theme.primaryLight, borderColor: theme.primaryBorder }]}
                    ...
                    {resolvedAvatar && (
                      <TouchableOpacity
                        style={[styles.avatarActionBtn, { backgroundColor: theme.dangerLight, borderColor: theme.dangerBorder }]}
                      ...
                      >
                        {isRemovingAvatar ? (
                          ...
                          <>
                            ...
                            <Text style={[styles.avatarActionText, { color: theme.danger }]}>Remove</Text>
                          </>
                        )}
                      </TouchableOpacity>
                    )}
                ...
                <View style={styles.heroMeta}>
                  <Text style={[styles.heroName, { color: theme.textMain }]} numberOfLines={1}>
              ...
              <View style={[styles.sectionCard, { backgroundColor: theme.bgCard, borderColor: theme.borderSubtle }]}>
                ...
                <View style={styles.themeModeGrid}>
                  <TouchableOpacity
                    style={[
                      styles.themeModeBtn,
                      {
                        backgroundColor: themeMode === 'dark' ? theme.primaryLight : theme.bgInput,
                        borderColor: themeMode === 'dark' ? theme.primary : theme.borderSubtle,
                      },
                    ]}
                  ...
                  >
                    ...
                    <Text
                      style={[
                        ...
                        { color: themeMode === 'dark' ? theme.primary : theme.textMain },
                      ]}
                    >
                      Dark Mode
                    </Text>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.themeModeBtn,
                      {
                        backgroundColor: themeMode === 'light' ? theme.primaryLight : theme.bgInput,
                        borderColor: themeMode === 'light' ? theme.primary : theme.borderSubtle,
                      },
                    ]}
                  ...
                  >
                    ...
                    <Text
                      style={[
                        styles.themeModeText,
                        { color: themeMode === 'light' ? theme.primary : theme.textMain },
                      ]}
                    >
                      Light Mode
                    </Text>
                ...
                <View style={styles.accentContainer}>
                  <Text style={[styles.fieldLabel, { color: theme.textMuted }]}>
                    Accent Color: {ACCENT_PALETTES[currentAccent]?.label || 'Blue'}
                  </Text>
              ...
              <View style={[styles.sectionCard, { backgroundColor: theme.bgCard, borderColor: theme.borderSubtle }]}>
                ...
                <View style={styles.nameRow}>
                  <View style={[styles.inputBox, { backgroundColor: theme.bgInput, borderColor: theme.borderSubtle, flex: 1 }]}>
                    <TextInput
                  ...
                  <TouchableOpacity
                    style={[styles.saveNameBtn, { backgroundColor: theme.primary }]}
              ...
              <TouchableOpacity
                style={[styles.togglePassBtn, { backgroundColor: theme.bgCard, borderColor: theme.borderSubtle }]}
                onPress={() => setShowPasswordSection(!showPasswordSection)}
                activeOpacity={0.7}
              >
                <View style={styles.togglePassLeft}>
                  <Feather name="lock" size={15} color={theme.primary} />
                  <Text style={[styles.togglePassTitle, { color: theme.textMain }]}>Change Password</Text>
                </View>
                <Feather
              ...
              {showPasswordSection && (
                <View style={[styles.passwordBox, { backgroundColor: theme.bgInput, borderColor: theme.borderSubtle }]}>
                  {/* Current Password */}
                  <View style={styles.passInputWrapper}>
                    <Text style={[styles.fieldLabel, { color: theme.textMuted }]}>Current Password</Text>
                    <View style={[styles.inputBox, { backgroundColor: theme.bgApp, borderColor: theme.borderSubtle }]}>
                      <Feather name="key" size={14} color={theme.textMuted} style={styles.inputIcon} />
                      <TextInput
                        style={[styles.input, { color: theme.textMain }]}
                      ...
                      <TouchableOpacity onPress={() => setShowOldPass(!showOldPass)} style={styles.eyeBtn}>
                        <Feather name={showOldPass ? 'eye-off' : 'eye'} size={15} color={theme.textMuted} />
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  {/* New Password */}
                  <View style={styles.passInputWrapper}>
                    <Text style={[styles.fieldLabel, { color: theme.textMuted }]}>New Password (min 6 characters)</Text>
                    <View style={[styles.inputBox, { backgroundColor: theme.bgApp, borderColor: theme.borderSubtle }]}>
                      <Feather name="shield" size={14} color={theme.textMuted} style={styles.inputIcon} />
                      <TextInput
                        style={[styles.input, { color: theme.textMain }]}
                      ...
                      <TouchableOpacity onPress={() => setShowNewPass(!showNewPass)} style={styles.eyeBtn}>
                        <Feather name={showNewPass ? 'eye-off' : 'eye'} size={15} color={theme.textMuted} />
                      </TouchableOpacity>
                    </View>
                  </View>

                  <TouchableOpacity
                    style={[styles.updatePassBtn, { backgroundColor: theme.emerald }]}
              ...
              {/* Log Out Action */}
              <TouchableOpacity
                style={[styles.logoutBtn, { borderColor: theme.dangerBorder, backgroundColor: theme.dangerLight }]}
                onPress={handleLogoutPress}
                activeOpacity={0.8}
              >
                <Feather name="log-out" size={15} color={theme.danger} />
                <Text style={[styles.logoutBtnText, { color: theme.danger }]}>Sign Out of Contexify</Text>
              </TouchableOpacity>
            </ScrollView>
          </Pressable>
        </Pressable>
