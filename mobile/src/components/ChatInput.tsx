  ...
  return (
    <View style={[styles.outerContainer, { backgroundColor: theme.bgApp }]}>
      ...
      {(documents.length > 0 || isUploading) && (
        ...
        >
          {isUploading && (
            <View style={[styles.uploadingChip, { backgroundColor: colors.primaryLight, borderColor: colors.primaryBorder }]}>
              <ActivityIndicator size="small" color={colors.primary} />
              <Text style={[styles.chipText, { color: colors.primary }]}>Vectorizing file...</Text>
            </View>
          )}
        ...
        {isSending ? (
          ...
          <TouchableOpacity
            style={[
              styles.sendButton,
              {
                backgroundColor: canSend ? colors.primary : theme.borderSubtle,
