...
export const MessageList: React.FC<MessageListProps> = ({
  ...
  return (
    <div className="relative flex-1 overflow-hidden flex flex-col w-full">
      ...
      >
        <div className="mx-auto flex justify-center gap-6 items-start w-full">
          {/* Main conversation column with stable fixed width */}
          <div className="w-full max-w-3xl flex flex-col gap-5 shrink-0">
            {showWelcome && (
            ...
            {messages.map((msg, idx) => {
              // Find preceding user question for title in sources popover
              ...
              const isThisSourceActive = activeSources?.messageId === msg.id;
              ...
              return (
                <MessageItem
                  ...
                  onToggleSources={(cits) =>
                    handleToggleSources(msg.id, cits, precedingUserQuery)
                  }
                />
              );
            })}
            ...
            {streamingMessage && (
              <MessageItem
                ...
                isSourcesActive={activeSources?.messageId === "streaming"}
                onToggleSources={(cits) =>
                  handleToggleSources(
                    "streaming",
                    cits,
          ...
          {activeSources && (
            <div className="hidden lg:block shrink-0 sticky top-2">
              <SourcesPopover
