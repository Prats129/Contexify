...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      ...
      currentAccent.gradientFrom,
    );
    root.style.setProperty(
      "--color-primary-gradient-to",
      currentAccent.gradientTo,
    );
    ...
    if (mode === "dark") {
      ...
      root.style.setProperty("--text-main", "#020617"); // Slate 950
      root.style.setProperty("--text-muted", "#334155"); // Slate 700
      root.style.setProperty("--border-subtle", "rgba(0, 0, 0, 0.10)");
      root.style.setProperty("--border-hover", "rgba(0, 0, 0, 0.22)");
    }
